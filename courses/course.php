...
<body>
  ...
  <div class="bg-[#ffffff]" id="main_content">
    <?php
    $c1 = 'cyan';
    $c2 = 'purple';
    $c3 = 'indigo';
    ...
    <div class="grid grid-cols-3 p-4 text-white bg-gradient-to-r from-<?php echo $random_color_1 ?>-500 to-<?php echo $random_color_2 ?>-500">
      <div class="col-span-2 p-4 ml-40">
        ...
        <button class="bg-[#ffe357] hover:bg-yellow-200 p-3 rounded-md font-bold w-3/2 mt-2 text-black" id="enroll">Enroll
          Now</button>
          ...
          <div class="p-2">
            ...
            <div class="grid grid-rows-4 grid-flow-col gap-2 w-fit mt-4">
              ...
              <div class="col-span-2 inline-flex pl-2">
                ...
                <p>
                  <?php
                  $countcours = "SELECT COUNT(*) as total FROM courses_details WHERE instructor_id = '" . $co_row['instructor_id'] . "'";
                  $res1 = $conn->query($countcours);
                  $r1 = $res1->fetch_assoc();
                  echo $r1['total'] . ' courses';
                  ?>
                </p>
              </div>
            </div>
        ...
        <div class="border p-4 shadow-lg rounded-xl h-fit mt-4">
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo '<button class="bg-indigo-700 text-white text-bold p-2 justify-center mr-2 rounded-lg font-bold" id="enroll1">Enroll Now</button>';
              echo '</div>';
              echo '</div>';
            }
          } else {
      ...
      <div class="relative">
        <div class="sticky top-5 bg-indigo-500 text-white p-4 border rounded-lg shadow-xl h-fit">
          ...
          <div class="flex justify-center">
            ...
            $getVideo = "SELECT module_data FROM modules_details WHERE cid = '$cid'";
            $vid = $conn->query($getVideo);
            $vid_row = $vid->fetch_assoc();

            $data = $vid_row['module_data'];
            $arr_data = json_decode($data, true);
            $guid = $arr_data[0]['guid0'];
          ...
          <div class="">
            <div class="price p-4">
              ...
              <button class="bg-blue-600 p-3 rounded-full font-bold w-full mt-2 hover:bg-blue-500 hover:transition-shadow" id="enroll2">Enroll
                Now</button>
            ...
            echo '<div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
                                    ...
                                    <div class="flex items-center">
                                        <img src="https://cdn.dribbble.com/users/2364329/screenshots/10481283/media/f013d5235bfcf1753d56cad154f11a67.jpg" alt="Avatar" class="rounded-full mr-4" width="64" height="64">
                                        <div>
  ...
  <div class="grid grid-cols-2 mt-12 mb-12">
    <div class="ml-44 p-2 pl-14">
      ...
      <div class="grid-rows-auto">
        ...
        <button class="bg-blue-600 hover:bg-yellow-200 p-3 rounded-md font-bold w-3/2 mt-4 text-white p-2 rounded-full" id="enroll3">Enroll
          Now</button>
      </div>
    </div>
    <div class="mr-44 p-2">
    ...
    $("#enroll").click(function() {
      $.ajax({
        ...
        success: function(response) {
          ...
          window.location.href = "/pay/payment.php?cid=" + cid;
        },
