...
?>
  ...
  <body>
    ...
    <div>
      <h1 class="font-bold text-xl pl-4">Your Enrolled Courses</h1>
      <button class="bg-blue-400 p-2 ml-4 rounded-full text-white font-bold mt-2" id="addcard">Add Payment Details</button>
    </div>
